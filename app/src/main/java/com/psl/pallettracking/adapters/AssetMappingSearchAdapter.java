...
public class AssetMappingSearchAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    ...
    public AssetMappingSearchAdapter(Context context,ArrayList<String> equipmentList) {
