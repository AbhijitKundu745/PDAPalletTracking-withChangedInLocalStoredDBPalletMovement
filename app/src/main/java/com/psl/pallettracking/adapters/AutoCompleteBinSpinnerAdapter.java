...
public class AutoCompleteBinSpinnerAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    ...
    public AutoCompleteBinSpinnerAdapter(Context context,ArrayList<String> equipmentList) {
    ...
    public View getSelectedView(int position) {
        ...
        if (position == 0) {
            ...
            TextView dispalyName = (TextView) view.findViewById(R.id.textEquipmentNumber);
            //letters.setImageDrawable(getTextDrawable(mStrings.get(position-1)));
            String eqnumber = mStrings.get(position-1);
            dispalyName.setText(eqnumber);
        }
        return view;
    }
    ...
    public View getNoSelectionView() {
        ...
        if(mStrings!=null){
            if(mStrings.size()>0){
                TxtVw_NoSelection.setText("Select Bin");
