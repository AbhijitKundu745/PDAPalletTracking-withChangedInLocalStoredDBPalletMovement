...
public class LocationSelectionAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    ...
    public LocationSelectionAdapter(Context context,ArrayList<String> equipmentList) {
    ...
    public View getNoSelectionView() {
        ...
        if(mStrings!=null){
            if(mStrings.size()>0){
                TxtVw_NoSelection.setText("Select Location");
                TxtVw_NoSelection.setTextColor(mContext.getResources().getColor(R.color.black));
            }else{
                TxtVw_NoSelection.setText("No Location Found");
